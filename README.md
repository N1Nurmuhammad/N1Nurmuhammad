...
- Design and build **REST APIs** and backend services with Django & FastAPI
- Develop **Telegram bots and mini-apps** using aiogram
- Work with **PostgreSQL**, containerize with **Docker**, and collaborate via **Git**
- Write practical, well-structured code with an eye on readability and maintainability
