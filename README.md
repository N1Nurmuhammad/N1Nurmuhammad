...
<p align="center">Software Engineer · 3+ years in Backend, Payments & High-Traffic Platforms · Tashkent, Uzbekistan 🇺🇿</p>

---

### 👨‍💻 About me

Software Engineer with **3+ years** building scalable backend systems, payment
integrations, and high-traffic platforms across **fintech, telecom, and
...
- **[Unired.uz](https://unired.uz)** — Payment aggregation platform connecting banks & merchants · `Python · FastAPI · PostgreSQL`
- **[ITUnisoft.uz](https://itunisoft.uz)** — Corporate platform with open data, tenders & fiscal API · `Python · FastAPI · PostgreSQL`
- **[Ucell.uz](https://ucell.uz)** — National telecom portal, 10M+ total / 3M+ daily users · `Python · Nginx · SEO`
...
**Payment Systems**
![Payme](https://img.shields.io/badge/Payme-00CFFF?style=flat&logo=telegram&logoColor=white)
![Click](https://img.shields.io/badge/Click-0099FF?style=flat&logoColor=white)
![Paygine](https://img.shields.io/badge/Paygine-6B3FA0?style=flat&logoColor=white)

### 🎓 Education

**Tashkent State Technical University** — B.Sc. Automation Power Engineering · 2020 – 2025
